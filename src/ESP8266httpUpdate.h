...
public:
    ...
    t_httpUpdate_return update(const String& url, const String& currentVersion = "");
    /*new*/
    t_httpUpdate_return update(const String& url, String payload, const bool n, const String& currentVersion = "");
...
protected:
    ...
    /*new*/
    t_httpUpdate_return handleUpdate(HTTPClient& http, const String& currentVersion, String payload, bool spiffs = false);
